...
#ifndef CUBICAPTURE_SWIFT_H
#define CUBICAPTURE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CubiCapture",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface CCCapture : ARSCNView <ARSCNViewDelegate, ARSessionDelegate>
...
SWIFT_CLASS("_TtC11CubiCapture11VideoWriter")
